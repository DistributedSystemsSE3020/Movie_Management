...
function SignUp() {
    ...
    return (
            <div className="bg_signup0" align="center">
                 <img
        className="homeimg"
                ...
                <div className="row">
                    ...
                    <div className="col-11">
                        <div className="pb-2 px-5 d-flex align-items-center justify-content-between">
                            <h2 className='h2_signup0' align="center">Register</h2>
                        </div>
                    </div>
                </div>
                <div className="card-form  form_signUp0">
               
                    <form onSubmit={register} className="boxSignUp0">
                    <br/><br/> <br/><br/>
                        <div className="row">
                            <div className="col-8">
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        <div className="form-group0">
                                            ...
                                            <label for="terms">&nbsp;I agree to the <Link className="signup" to="/terms">Terms and Conditions</Link>.</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="form-group0">
                                        <label htmlFor="profilepic">
                                            ...
                                            <Button className="button2" color="primary" variant="contained" component="span">
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="form-group0">
                                    <input className="form-submit-btn  btn_sign_up button_location" type="submit" value="Sign Up" />
                                </div>
                            </div>
                        </div>
                        
                        <p>Already have an account? <Link className="signup" to="/customer/signin">Sign In</Link></p>
                    </form>             
                </div>                   
            </div>
    )
